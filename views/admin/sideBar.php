...
<div id="sidebar-left" class="span2">
    <div class="nav-collapse sidebar-nav">
        <ul class="nav nav-tabs nav-stacked main-menu">
            <li><a href="http://localhost/brighter2morrow/views/admin/index.php"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>	
            <li><a href="http://localhost/brighter2morrow/views/admin/userlist.php"><i class="icon-envelope"></i><span class="hidden-tablet"> User List</span></a></li>
            ...
            <li><a href="http://localhost/brighter2morrow/views/common/category.php"><i class="icon-tasks"></i><span class="hidden-tablet">Add Category</a></li>
